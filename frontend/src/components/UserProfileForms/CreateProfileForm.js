...
const CreateProfileForm = () => {
  ...
  const handleProfileSubmit = (e) => {
    e.preventDefault();
    setErrors([]);
    if (firstName === '' || age === '' || location === '' || gender === '' || genderPreference === '' || favLang === '' || tabSpace === '' || macPc === '' || lightDark === '' || bio ==='') {
          ...
          <div className="user-profile-form-container">
            <div className="user-profile-form-left">
              <div className="first-name-container">
                ...
                <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)}  className="profile-form-input"/>
              </div>
              <div className="age-container">
                <label htmlFor="age" className="profile-input-header">Age: </label>
                <input type="text" value={age} onChange={(e) => setAge(e.target.value)}  className="profile-form-input" />
              </div>
              <div className="city-container">
                <label htmlFor="location" className="profile-input-header">City: </label>
                <input type="text" value={location} onChange={(e) => setLocation(e.target.value)}  className="profile-form-input" />
              </div>
              <div className="bio-container">
                <label htmlFor="bio" className="profile-input-header">Bio: </label>
                <br />
                <textarea value={bio} onChange={(e) => setBio(e.target.value)} id="bio-field" placeholder="Tell others about yourself." />
              </div>
              <div className="gender-container">
                <h2 className="profile-input-header">Gender:</h2>
                <div className="profile-buttons-container">
                  <button type="button" className={genderStyle["F"]} value="F" onClick={() => handleGender("F")}>Woman</button>
                  <button type="button" className={genderStyle["M"]} value="M" onClick={() => handleGender("M")}>Man</button>
                  <button type="button" className={genderStyle["N"]} value="N" onClick={() => handleGender("N")}>Nonbinary</button>
                </div>
              </div>
              <div className="gender-pref-container">
                <h2 className="profile-input-header">I'm Looking For:</h2>
                <div className="profile-buttons-container">
                  <button type="button" className={genderPrefStyle["M"]} onClick={() => handleGenderPref("M")}>Men</button>
                  <button type="button" className={genderPrefStyle["F"]} onClick={() => handleGenderPref("F")}>Women</button>
                  <button type="button" className={genderPrefStyle["N"]} onClick={() => handleGenderPref("N")}>Nonbinary People</button>
                  <button type="button" className={genderPrefStyle["NP"]} onClick={() => handleGenderPref("NP")}>No Preference</button>
                </div>
              </div>
            </div>
            <div className="user-profile-form-right">  
              <div className="fav-lang-container">
                ...
                <div className="profile-buttons-container">
                  <button type="button" className={favLangStyle["javascript"]} onClick={() => handleFavLang("javascript")}>Javascript</button>
                  <button type="button" className={favLangStyle["python"]} onClick={() => handleFavLang("python")}>Python</button>
                  <button type="button" className={favLangStyle["c"]} onClick={() => handleFavLang("c")}>C</button>
                  <button type="button" className={favLangStyle["ruby"]} onClick={() => handleFavLang("ruby")}>Ruby</button>
                  <button type="button" className={favLangStyle["java"]} onClick={() => handleFavLang("java")}>Java</button>
                  <button type="button" className={favLangStyle["html-css"]} onClick={() => handleFavLang("html-css")}>HTML/CSS</button>
                  <button type="button" className={favLangStyle["sql"]} onClick={() => handleFavLang("sql")}>SQL</button>
                </div>
              </div>
              <div className="tabs-spaces-container">
                <h2 className="profile-input-header" >Tabs vs. Spaces:</h2>
                <div className="profile-buttons-container">
                  <button type="button" className={tabSpaceStyle["tabs"]} onClick={() => handleTabSpace("tabs")}>Tabs</button>
                  <button type="button" className={tabSpaceStyle["spaces"]} onClick={() => handleTabSpace("spaces")}>Spaces</button>
                </div>
              </div>
              <div className="mac-pc-container">
                <h2 className="profile-input-header" >Mac vs. PC:</h2>
                <div className="profile-buttons-container">
                  <button type="button" className={macPcStyle["mac"]} onClick={() => handleMacPc("mac")}>Mac</button>
                  <button type="button" className={macPcStyle["pc"]} onClick={() => handleMacPc("pc")}>PC</button>
                </div>
              </div>
              <div className="light-dark-container">
                <h2 className="profile-input-header">Light Theme vs. Dark Theme:</h2>
                <div className="profile-buttons-container">
                  <button type="button" className={lightDarkStyle["light"]} onClick={() => handleLightDark("light")}>Light</button>
                  <button type="button" className={lightDarkStyle["dark"]} onClick={() => handleLightDark("dark")}>Dark</button>
                </div>
              </div>
